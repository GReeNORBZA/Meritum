# Task D05-020: Service: provider profile management and onboarding
...
This task depends on the following completed tasks: D05-010
...
```typescript
  it('getProviderProfile returns complete profile for active provider', async () => { /* implement */ });
  it('updateProviderProfile updates fields and emits audit event', async () => { /* implement */ });
  it('updateProviderProfile captures field-level diff in audit detail', async () => { /* implement */ });
  it('getOnboardingStatus reports missing fields accurately', async () => { /* implement */ });
  it('completeOnboarding succeeds when all required fields populated', async () => { /* implement */ });
  it('completeOnboarding fails listing missing fields', async () => { /* implement */ });
  it('createProviderFromOnboarding creates provider with provider_id = userId', async () => { /* implement */ });
```
