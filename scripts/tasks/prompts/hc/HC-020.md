# Task HC-020: Tracking rejection patterns

## What to Build

Write the help centre article: `help-centre/after-submission/tracking-rejection-patterns.md`

**Front matter values for this article:**
- title: "Tracking rejection patterns"
- category: after-submission
- slug: tracking-rejection-patterns
- type: procedural
- priority: 2
...
```bash
node scripts/validate-article.js help-centre/after-submission/tracking-rejection-patterns.md
```
