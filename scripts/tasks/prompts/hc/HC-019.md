# Task HC-019: Correcting and resubmitting refused claims

## What to Build

Write the help centre article: `help-centre/after-submission/correcting-and-resubmitting-refused-claims.md`

**Front matter values for this article:**
- title: "Correcting and resubmitting refused claims"
- category: after-submission
- slug: correcting-and-resubmitting-refused-claims
- type: procedural
- priority: 2
...
```bash
node scripts/validate-article.js help-centre/after-submission/correcting-and-resubmitting-refused-claims.md
```
